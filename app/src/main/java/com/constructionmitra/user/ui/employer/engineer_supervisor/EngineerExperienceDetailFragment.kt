...
class EngineerExperienceDetailFragment : Fragment() {
    ...
    private var _binding: FragmentEngineerExperianceDetailsBinding?=null
    ...
    override fun onCreateView(
        ...
        _binding= FragmentEngineerExperianceDetailsBinding.inflate(inflater,container,false).apply {
